...
// ВАЖНО: Вставьте актуальный публичный anon key вашего проекта
...
window.__PB_RUNTIME__.DEBUG_AUTH = window.__PB_RUNTIME__.DEBUG_AUTH ?? false;  // Отключить после тестирования
window.__PB_RUNTIME__.AUTH_INIT_TIMEOUT_MS = window.__PB_RUNTIME__.AUTH_INIT_TIMEOUT_MS ?? 20000;  // Увеличен для продакшена