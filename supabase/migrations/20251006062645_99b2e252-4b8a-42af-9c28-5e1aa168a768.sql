...
DROP FUNCTION IF EXISTS public.get_products_with_notification_issues(integer, integer, text, text, uuid);

-- Create updated RPC function that returns ALL product fields
...
-- Create new RPC function for counting products with notification issues
