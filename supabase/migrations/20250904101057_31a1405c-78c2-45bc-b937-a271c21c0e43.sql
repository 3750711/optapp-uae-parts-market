-- Drop all specific versions of admin_create_order function
DROP FUNCTION IF EXISTS public.admin_create_order(text, numeric, uuid, uuid, text, text, text, text, text, order_status, order_created_type, delivery_method, integer, text, numeric, text, text[], text[], uuid) CASCADE;

DROP FUNCTION IF EXISTS public.admin_create_order(text, numeric, uuid, uuid, text, text, text, text, text, order_status, order_created_type, text, integer, text, numeric, text, text[], uuid) CASCADE;

DROP FUNCTION IF EXISTS public.admin_create_order(text, numeric, uuid, uuid, text, text, text, text, text, order_status, order_created_type, delivery_method, integer, text, numeric, text, text[], uuid) CASCADE;

-- Create a single, stable version of admin_create_order
