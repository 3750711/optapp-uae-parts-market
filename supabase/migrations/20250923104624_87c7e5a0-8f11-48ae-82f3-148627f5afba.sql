-- Drop and recreate create_trusted_product function with correct parameter order
DROP FUNCTION IF EXISTS public.create_trusted_product(text, numeric, text, text, text, text, integer, numeric);
