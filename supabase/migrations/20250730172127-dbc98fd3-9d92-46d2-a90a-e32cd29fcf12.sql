-- First, unschedule the existing broken cron job
SELECT cron.unschedule('send-periodic-admin-notifications');

-- Create a new cron job with simplified JSON body (no dynamic timestamp)
