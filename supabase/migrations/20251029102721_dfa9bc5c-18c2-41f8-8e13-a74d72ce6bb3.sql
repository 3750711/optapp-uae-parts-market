-- Fix #9: Add access control to get_orders_shipment_summary RPC
-- Fix #4: Create RPC function for batch updates with transaction

-- Fix #9: Add role check to get_orders_shipment_summary
...
-- Fix #4: Create RPC function for atomic batch updates with transaction
...
-- Grant execute permissions to authenticated users (RLS will be checked inside function)
