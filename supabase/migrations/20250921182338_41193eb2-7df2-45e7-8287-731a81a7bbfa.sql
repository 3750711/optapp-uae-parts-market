-- Исправляем представление products_with_view_estimate 
-- Передаем правильные параметры в функцию estimate_tg_views
...
SELECT p.id,
    ...
    p.tg_notify_error,
    p.catalog_position,
    -- Используем функцию estimate_tg_views с правильными параметрами
