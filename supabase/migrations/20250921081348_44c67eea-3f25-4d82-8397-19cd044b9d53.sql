...
CREATE INDEX IF NOT EXISTS idx_profiles_public_share_token ON public.profiles(public_share_token) 
WHERE public_share_enabled = true AND public_share_expires_at > now();
