-- Fix ambiguous column reference in hybrid_search_products function
...
BEGIN
  ...
  WITH semantic_results AS (
    SELECT 
      ...
      p.status,
      p.created_at,  -- Explicitly use products.created_at
    ...
    LEFT JOIN (
      ...
      ORDER BY product_id, product_images.created_at DESC  -- Explicitly use product_images.created_at
