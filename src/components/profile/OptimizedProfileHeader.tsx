          ...
          <div className="relative">
            ...
            {onAvatarUpdate && (
              <div className="absolute bottom-0 right-0">
                <button 
                  type="button"
                  className="flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-optapp-yellow to-yellow-400 text-optapp-dark hover:from-yellow-400 hover:to-yellow-500 cursor-pointer shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 relative"
