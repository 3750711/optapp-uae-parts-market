...
const ContactButtons: React.FC<ContactButtonsProps> = ({
  ...
  // Show verification warning for blocked sellers
  ...
  // Always show contact buttons if phone or telegram exists and user is authenticated
  const hasContactInfo = sellerPhone || sellerTelegram;
  
  if (!hasContactInfo) {
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <p className="text-sm text-gray-600">Контактная информация продавца недоступна</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 border rounded-lg p-4 bg-white">
      <h4 className="font-medium text-gray-900">Связаться с продавцом</h4>
