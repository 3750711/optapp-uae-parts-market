...
const OrderCreationProgress: React.FC<OrderCreationProgressProps> = ({ currentStep }) => {
  ...
  const steps = [
    { num: 1, title: "Продавец", completed: currentStep > 1 },
    { num: 2, title: "Товар", completed: currentStep > 2 },
    { num: 3, title: "Покупатель", completed: currentStep > 3 },
...
export default OrderCreationProgress;
