...
export const CSP_DIRECTIVES = {
  ...
  'script-src': ["'self'", "'unsafe-inline'", "'unsafe-eval'", "data:", "blob:", "https://cdn.gpteng.co", "https://www.clarity.ms", "https://scripts.clarity.ms", "https://telegram.org", "https://cdn.jsdelivr.net"],
  'script-src-elem': ["'self'", "'unsafe-inline'", "'unsafe-eval'", "data:", "https://cdn.gpteng.co", "https://www.clarity.ms", "https://scripts.clarity.ms", "https://telegram.org", "https://cdn.jsdelivr.net"],
