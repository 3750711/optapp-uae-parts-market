...
const OptimizedProductDetail = () => {
  ...
  // Параллельные запросы для продукта и профиля продавца
    ...
    queries: [
      ...
      },
      {
        ...
        queryFn: async () => {
          ...
          // Сначала получаем seller_id из продукта
          ...
          if (!productData?.seller_id) return null;
  ...
  // Показываем skeleton вместо полноэкранного спиннера
