...
const RequestPartsPromo = () => (
  <div className="relative overflow-hidden rounded-xl mb-12 mt-6 p-6 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-fade-in">
    ...
    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Запросы на запчасти</h2>
    ...
    <div className="bg-background">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6">
          {/* Add RequestPartsPromo at the top of this section */}
          <RequestPartsPromo />
