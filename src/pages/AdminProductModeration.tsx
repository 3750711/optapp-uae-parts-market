      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm text-muted-foreground">
              {pendingProducts.length} products awaiting moderation
            </span>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">No products to moderate</h3>
            <p className="text-muted-foreground">All products have been processed</p>
          </div>
        ) : (
